...
--Süre Pastesi
--Bitiş
gg.alert("⚠️𝐆ü𝐧𝐜𝐞𝐥𝐥𝐞𝐦𝐞𝐥𝐞𝐫⚠️\n𝙰𝚗𝚝𝚒 𝙱𝚊𝚗 𝙶ü𝚗𝚌𝚎𝚕𝚕𝚎𝚗𝚍𝚒✅")
...
gg.addListItems({[1] = {address = jz[i].address + 240,flags = 4,freeze = true,value = 16384}})
gg.addListItems({[1] = {address = jz[i].address + 244,flags = 4,freeze = true,value = 16384}})
end
end
gg.clearList()
gg.clearResults()
gg.setRanges(gg.REGION_C_ALLOC)
gg.searchNumber("131330;135682::401", gg.TYPE_DWORD, false, gg.SIGN_EQUAL, 0, -1)
if gg.getResultCount() == 0 then
gg.processKill()
os.exit()
else
...
jz = gg.getResults(n)
for i = 1, n do
gg.addListItems({[1] = {address = jz[i].address + 160,flags = 4,freeze = true,value = 16384}})
gg.addListItems({[1] = {address = jz[i].address + 280,flags = 4,freeze = true,value = 16384}})
gg.addListItems({[1] = {address = jz[i].address + 400,flags = 4,freeze = true,value = 16384}})
gg.addListItems({[1] = {address = jz[i].address + 560,flags = 4,freeze = true,value = 16384}})
gg.addListItems({[1] = {address = jz[i].address + 720,flags = 4,freeze = true,value = 16384}})
gg.addListItems({[1] = {address = jz[i].address - 160,flags = 4,freeze = true,value = 16384}})
gg.addListItems({[1] = {address = jz[i].address - 280,flags = 4,freeze = true,value = 16384}})
gg.addListItems({[1] = {address = jz[i].address - 400,flags = 4,freeze = true,value = 16384}})
gg.addListItems({[1] = {address = jz[i].address - 560,flags = 4,freeze = true,value = 16384}})
...
gg.clearResults()
gg.setRanges(gg.REGION_C_ALLOC)
gg.searchNumber("131330;133378", gg.TYPE_DWORD)
...
gg.clearResults()
gg.setRanges(gg.REGION_C_ALLOC)
gg.searchNumber("134914;101852", gg.TYPE_DWORD)
