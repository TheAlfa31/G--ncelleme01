...
gg.processResume()
gg.processResume()
gg.searchNumber("65535", gg.TYPE_DWORD, false, gg.SIGN_EQUAL, 0, -1, 0)
gg.processResume()
gg.processResume()
gg.searchNumber("262143", gg.TYPE_DWORD, false, gg.SIGN_EQUAL, 0, -1, 0)
gg.processResume()
...
gg.processResume()
gg.clearResults()
gg.searchNumber("131073", gg.TYPE_DWORD, false, gg.SIGN_EQUAL, 0, -1, 0)
gg.processResume()
gg.processResume()
gg.clearResults()
...
gg.processResume()
gg.clearResults()
gg.searchNumber("196608", gg.TYPE_DWORD, false, gg.SIGN_EQUAL, 0, -1, 0)
gg.processResume()
gg.clearResults()
gg.searchNumber("192512", gg.TYPE_DWORD, false, gg.SIGN_EQUAL, 0, -1, 0)
gg.processResume()
...
sf=gg.choice({
	...
	"🤯Brutal Kafadan Vurma[Lobi+Oyun]🤯"..elli_kafadanchecker,
	"➕Küçük Artı➕[Oyun]",
